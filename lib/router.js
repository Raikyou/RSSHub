...
// 工信部
router.get('/miit/jsgxt/:id', require('./routes/miit/jsgxt'));
router.get('/miit/wxgxj/:id', require('./routes/miit/wxgxj'));
router.get('/miit/wxqyfw/:id', require('./routes/miit/wxqyfw'));
router.get('/miit/wxrmzf/:id', require('./routes/miit/wxrmzf'));
router.get('/miit/cqrmzf/:id', require('./routes/miit/cqrmzf'));
router.get('/miit/cqjxw/:id', require('./routes/miit/cqjxw'));
